...
class ProjectWiseEstimateItemConsumeState
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData['status'] == 200) {
          setState(() {
            projects = List<String>.from((responseData['data'] ?? [])
  ...
  Future<void> _dropDownToProjectLocation(String project) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData['status'] == 200) {
          setState(() {
            locations = List<String>.from((responseData['data'] ?? [])
                ...
                children: [
                  ...
                  for (var estimation in _activeEstimationList)
                    TableRow(
                      decoration: BoxDecoration(
                        color:
                            _activeEstimationList.indexOf(estimation) % 2 == 0
                                ? Colors.white
                                : Colors.grey[50],
                      ),
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            NumberStyles.qtyStyle(
                                estimation.estimatedQuantity.toString()),
                            style: TextStyle(
                                color: Colors.grey[800], fontSize: 13),
                        ...
                        Padding(
                          ...
                          child: Text(
                            NumberStyles.currencyStyle(
                                estimation.actualUnitPrice.toString()),
                            style: TextStyle(
                                color: Colors.grey[800], fontSize: 13),
                            textAlign: TextAlign.right,
                          ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            NumberStyles.currencyStyle(
                                estimation.estimatedAmount.toString()),
                            style: TextStyle(
                                color: Colors.grey[800], fontSize: 13),
                            textAlign: TextAlign.right,
                          ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            NumberStyles.qtyStyle(
                                estimation.totalRequestedQuantity.toString()),
                            style: TextStyle(
                                color: Colors.grey[800], fontSize: 13),
                            textAlign: TextAlign.right,
                          ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            NumberStyles.currencyStyle(
                                estimation.totalRequestedAmount.toString()),
                            style: TextStyle(
                                color: Colors.grey[800], fontSize: 13),
                            textAlign: TextAlign.right,
                          ),
                          ...
                          child: Text(
                            NumberStyles.currencyStyle(
                                (estimation.estimatedAmount -
                                        estimation.totalRequestedAmount)
                                    .toString()),
                            style: TextStyle(
                              color: _getBalanceColor(double.tryParse(
                                      (estimation.estimatedAmount -
                                              estimation.totalRequestedAmount)
                                          .toString()) ??
                                  0),
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  exportToCSV(parentContext, _activeEstimationList);
                },
              ),
            ],
          ),
  ...
  Future<void> exportToCSV(
      BuildContext context, List<EstimationItem> estimations) async {
    try {
      ...
      for (int i = 0; i < estimations.length; i++) {
        ...
        rows.add([
          ...
          NumberStyles.currencyStyle(
              estimation.totalRequestedAmount.toString()),
          NumberStyles.currencyStyle(
              (estimation.estimatedAmount - estimation.totalRequestedAmount)
                  .toString()),
  ...
  factory EstimationItem.fromJson(Map<String, dynamic> json) {
    return EstimationItem(
      ...
      totalRequestedQuantity:
          double.tryParse(json['total_requested_quantity']) ?? 0,
      totalRequestedAmount:
          double.tryParse(json['total_requested_amount']) ?? 0,
      remainingEstimateBalance:
          double.tryParse(json['remaining_estimate_balance']) ?? 0,
      remainingActualBalance:
          double.tryParse(json['remaining_actual_balance']) ?? 0,
