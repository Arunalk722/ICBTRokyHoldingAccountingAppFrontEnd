    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (status == 200) {
          ...
          await prefs.setInt(
              'req_pw_change', responseData['req_pw_change'] ?? 0);
          ...
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
                builder: (context) => HomePage(
                    isAdvance:
                        responseData['is_advance_mode'] == 1 ? true : false)),
          );
        } else {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  buildTextField(_userName, 'User Name', 'Enter your user name',
                      Icons.person, true, 20),
                  buildPwdTextField(_password, 'Password', 'Your password',
                      Icons.password_rounded, true, 20),
                  ElevatedButton(
                    onPressed: () {
                      if (APIInfo.getAPI() == APIHost().appVersion) {
                        loginSystem();
