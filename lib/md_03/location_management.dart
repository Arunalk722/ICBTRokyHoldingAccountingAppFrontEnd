...
class _LocationManagementState extends State<LocationManagement> {
  ...
  Future<void> _updateLocation(BuildContext context, int idtblProjectLocation,
    ...
    try {
      ...
      String reqUrl =
          '${APIHost().apiURL}/location_controller.php/EditLocation';
      PD.pd(text: reqUrl);
      ...
      if (response.statusCode == 200) {
        try {
          ...
          ExceptionLogger.logToError(
              ...
              logFile: 'location_management.dart');
          String errorMessage =
  ...
  Future<void> _deleteLocation(BuildContext context, int idtblProjectLocation,
    ...
    try {
      ...
      String reqUrl =
          '${APIHost().apiURL}/location_controller.php/DeleteLocation';
      PD.pd(text: reqUrl);
      final response = await http.post(
        Uri.parse(reqUrl),
        headers: HttpHeader().header,
  ...
  Future<void> createProjectLocation(BuildContext context) async {
    try {
      ...
      String reqUrl =
          '${APIHost().apiURL}/location_controller.php/RegisterLocation';
      PD.pd(text: reqUrl);
      final response = await http.post(
        Uri.parse(reqUrl),
        headers: HttpHeader().header,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Estimation Amount :${NumberFormat('#,###.00', 'en_US').format(double.tryParse(location['total_estimate_amount']) ?? 0)} LKR',
