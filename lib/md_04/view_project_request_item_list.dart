...
class _ViewConstructionRequestListState
    extends State<ViewConstructionRequestList> {
  ...
  Future<void> fetchRequestsById() async {
    ...
    try {
      ...
      ExceptionLogger.logToError(
          ...
          logFile: 'view_project_request_item_list.dart');
      WaitDialog.hideDialog(context);
      setState(() {
  ...
  Future<void> getDataRequestMateriaList() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(apiURL),
        headers: HttpHeader().header,
        body: jsonEncode({'request_id': widget.requestId}),
      );
      if (response.statusCode == 200) {
        WaitDialog.hideDialog(context);
        final responseData = jsonDecode(response.body);
  ...
  pw.Widget buildIouPdfPage(
    ...
    return pw.Column(
      children: paymentRequests.map((request) {
        ...
        double _billSubTotal =
            _billAmount + _vat + _sscl - (_addDis + _itemsDis);
          ...
          child: pw.Column(
            ...
            children: [
                ...
                child: pw.Column(
                  children: [
                    ...
                    pw.Text('ROKY Holdings (Pvt) LTD',
                        style: pw.TextStyle(fontSize: 10, font: normalFont)),
              ...
              pw.Row(
                ...
                children: [
                  pw.Container(
                    ...
                    child: pw.Text(
                        'IOU No:  ${IOUNumber.iouNumber(val: request.iouNumber.toString()) ?? '000000'}',
                ...
                child: pw.Column(
                  ...
                  children: [
                    pw.Row(
                      ...
                      children: [
                        pw.Text(
                            'Payment Requested BY: ${request.createdBy ?? ''}',
                            style: pw.TextStyle(fontSize: 8, font: normalFont)),
                        pw.Text(
                            'Requested Date & time: ${request.createdTime ?? ''}',
                            style: pw.TextStyle(fontSize: 8, font: normalFont)),
                      ],
                    ),
                ...
                child: pw.Column(
                  ...
                  children: [
                    pw.Row(
                      ...
                      children: [
                        pw.Text(
                            'Beneficiary Name: ${request.receiverName ?? ''}',
                            style: pw.TextStyle(fontSize: 8, font: normalFont)),
                    ...
                    pw.Row(
                      ...
                      children: [
                        pw.Text(
                            'Requested Amount: ${NumberStyles.currencyStyle(request.requested.toString())}',
                            style: pw.TextStyle(fontSize: 8, font: normalFont)),
                        pw.Text(
                            'Paid Amount: ${NumberStyles.currencyStyle(request.totalActualAmount.toString())}',
                            style: pw.TextStyle(fontSize: 8, font: normalFont)),
                      ],
                    ),
                  ],
                ...
                child: pw.Column(
                  ...
                  children: [
                    pw.Row(
                      ...
                      children: [
                        pw.Text(
                            'A/C holder Name: ${request.beneficiaryName ?? ''}',
                            style: pw.TextStyle(fontSize: 8, font: normalFont)),
              ...
              pw.Row(
                ...
                children: [
                  buildApprovalBox(
                      '${request.isAuth == -1 ? 'Reject' : 'Authorized'} By',
                      request.authUser,
                      request.authTime,
                      request.authCmt,
                      normalFont,
                      boldFont),
                  buildApprovalBox(
                      '${request.isAppro == -1 ? 'Reject' : 'Approved'} By',
                      request.approUser,
                      request.approTime,
                      request.approCmt,
                      normalFont,
                      boldFont),
                  buildApprovalBox('Paid By', request.pmtUser, request.pmtTime,
                      request.pmtCmt, normalFont, boldFont),
                ],
              ),
                        ...
                        children: [
                          ...
                          pw.Padding(
                            ...
                            child: pw.Text(
                              ...
                              style:
                                  pw.TextStyle(fontSize: 7, font: normalFont),
  ...
  pw.Widget buildApprovalBox(String title, String? name, String? date,
      String? remark, pw.Font normalFont, pw.Font boldFont,
      {String? account}) {
    return pw.Expanded(
      child: pw.Container(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        "Project: ${request.projectName} ${request.paymentType}",
                        style: TextStyle(
                    ...
                    Text("Location: ${request.locationName}",
                        style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 16)),
                    Text(
                        "Receiver: ${request.receiverName} |Type ${request.paymentType}",
                        style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 16)),
                    ...
                    if (request.paymentType == "Bank Transfer") ...[
                      SizedBox(height: 10),
                      Text(
                          "Beneficiary Name: ${request.beneficiaryName ?? 'N/A'}"),
                    ...
                    if (request.isAuth == 1 || request.isAuth == -1) ...[
                      SizedBox(height: 10),
                      Text(
                          "${request.isAuth == -1 ? 'Reject' : 'Authorized'} by: ${request.authUser ?? 'N/A'}"),
                      Text(
                    ...
                    if (request.isAppro == 1 || request.isAppro == -1) ...[
                      SizedBox(height: 10),
                      Text(
                          "${request.isAppro == -1 ? 'Reject' : 'Approved'} by: ${request.approUser ?? 'N/A'}"),
                        ...
                        viewImages(request.refNum.toString()).then((_) {
                          if (_imagesLists.isNotEmpty && mounted) {
                            ...
                            ScaffoldMessenger.of(_scaffoldKey.currentContext!)
                              ...
                              SnackBar(
                                content:
                                    Text('No images found for this request.'),
                                backgroundColor: Colors.red,
                              ),
                            );
                          }
                                  ...
                                  child: GestureDetector(
                                    onTap: () async {
                                      ...
                                      if (a == 1) {
                                        ...
                                        PD.pd(
                                            text:
                                                'Deleting image: ${removedImage.emageUrl}');
  ...
  Widget _buildRequestedItemsTable() {
    ...
    columns.add(const DataColumn(label: Text('Estimation')));
        ...
        child: DataTable(
          ...
          rows: _requestedItems.map((item) {
            final List<DataCell> cells = [
              ...
              DataCell(Container(
                constraints: BoxConstraints(maxWidth: 150),
                child: Text(item.materialDescription,
                  ...
                  onPressed: () {
                    if (item.newAmount! <= 0 || item.newQuantity! <= 0) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text(
                              'Please Change Amount and price before edit.'),
                          backgroundColor: Colors.red,
                        ),
                      );
                    } else {
                      YNDialogCon.ynDialogMessage(
                        context,
                        messageBody:
                            'Confirm to Edit Item ${item.materialDescription} QTY :${item.newQuantity} and amount ${item.newAmount}',
                ...
                IconButton(
                  ...
                  onPressed: () {
                    YNDialogCon.ynDialogMessage(
                      context,
                      messageBody:
                          'Confirm to remove Item ${item.materialDescription} QTY :${item.requestedQuantity}',
                      ...
                      if (value == 1) {
                        removeRequestItem(context, item.id,
                            item.materialDescription, item.requestId);
                      }
                    });
                  },
                ),
...
class PaymentRequest {
  ...
  factory PaymentRequest.fromJson(Map<String, dynamic> json) {
    return PaymentRequest(
      ...
      totalActualAmount: json['total_req_amount'].toString() ?? '0',
      pmtStatus: json['pmt_status'],
      pmtCmt: json['pmt_cmt'],
      pmtUser: json['pmt_user'],
      pmtTime: json['pmt_time'] ?? 'NA',
      createdBy: json['created_by'],
      paymentRef: json['payment_ref'] ?? "NA",
      createdTime: json['created_date'].toString(),
      sscl: json['sscl'] ?? '0',
      vat: json['vat'] ?? '0',
