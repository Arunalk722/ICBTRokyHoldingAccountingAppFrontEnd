...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Future<ApiResponse> _fetchNotifications() async {
    ...
    final String reqUrl =
        '${APIHost().apiURL}/report_controller.php/GetPendingRequests';
    PD.pd(text: reqUrl);
    try {
      final response = await http.post(
        Uri.parse(reqUrl),
        headers: HttpHeader().header,
        body: jsonEncode({'user_name': UserCredentials().UserName}),
      );
          ...
          child: ListTile(
            ...
            trailing: IconButton(
                ...
                onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => notification.type == 'office'
                            ? ViewOfzRequestList(
                      ...
                      DataCell(
                        IconButton(
                            ...
                            onPressed: () => Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => notification.type ==
                                            'office'
                                        ? ViewOfzRequestList(
                                            requestId:
