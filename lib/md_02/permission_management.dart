...
class _PermissionManagementPageState extends State<PermissionManagementPage> {
  ...
  Future<void> _dropDownToUsers() async {
    ...
    try {
      ...
      ExceptionLogger.logToError(
          ...
          logFile: 'permission_management.dart');
      Navigator.pop(context);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData['status'] == 200 &&
          ...
          setState(() {
            _txtCreditLimit.text =
                userPermission['aut_credit_limit']?.toString() ?? "0.0";
            _permissions['Approve Project IOU'] =
                userPermission['alw_auth'] == 1;
            _permissions['Approve Office IOU'] =
                userPermission['alw_ofz_auth'] == 1;
            _permissions['Pending Payment'] =
                userPermission['alw_req_pay'] == 1;
            _permissions['Office IOU Request'] =
                userPermission['alw_ofz_exp'] == 1;
            _permissions['Data Entry'] = userPermission['alw_cons_exp'] == 1;
            _permissions['Permission Manager'] = userPermission['alw_pm'] == 1;
            _permissions['Allow to Material Management'] =
                userPermission['alw_mm'] == 1;
            _permissions['Allow to Estimation Creating'] =
                userPermission['alw_ec'] == 1;
            _permissions['Report View'] = userPermission['alw_rpt'] == 1;
            _permissions['My IOU Request'] = userPermission['alw_prl'] == 1;
            _permissions['Allow To Project Management'] =
            ...
            _permissions['Expense & Task Designer'] =
                userPermission['alw_exp_task_plan'] == 1;
            _permissions['IOU Request'] = userPermission['alw_pbc'] == 1;
            _permissions['Office Expenses Design'] =
                userPermission['alw_ofz_tsk_desg'] == 1;
            _permissions['Project Estimation Edit'] =
                userPermission['alw_est_edit'] == 1;
            _permissions['Project Estimation Authorized'] =
                userPermission['alw_est_auth'] == 1;
            _permissions['Project Estimation Approve'] =
                userPermission['alw_est_appr'] == 1;
          });
  ...
  Future<void> _manageUserPermission() async {
    ...
    try {
      ...
      String reqUrl =
          '${APIHost().apiURL}/user_controller.php/ManageUserPermission';
      PD.pd(text: reqUrl);
      final response = await http.post(
        Uri.parse(reqUrl),
        headers: HttpHeader().header,
        body: jsonEncode({
          ...
          "aut_credit_limit": _txtCreditLimit.text.isNotEmpty
              ? _txtCreditLimit.text.replaceAll(',', '')
              : "0",
          ...
          "alw_mm":
              _permissions['Allow to Material Management'] == false ? 0 : 1,
          "alw_ec":
              _permissions['Allow to Estimation Creating'] == false ? 0 : 1,
          "alw_rpt": _permissions['Report View'] == false ? 0 : 1,
          "alw_prl": _permissions['My IOU Request'] == false ? 0 : 1,
          "alw_pm_create":
              _permissions['Allow To Project Management'] == false ? 0 : 1,
          "alw_lm": _permissions['Location Management'] == false ? 0 : 1,
          "alw_ofz_tsk_desg":
              _permissions['Office Expenses Design'] == false ? 0 : 1,
          "alw_est_edit":
              _permissions['Project Estimation Edit'] == false ? 0 : 1,
          "alw_est_auth":
              _permissions['Project Estimation Authorized'] == false ? 0 : 1,
          "alw_est_appr":
              _permissions['Project Estimation Approve'] == false ? 0 : 1,
          "is_active": _permissions['Active User'] == false ? 0 : 1,
          "alw_exp_task_plan":
              _permissions['Expense & Task Designer'] == false ? 0 : 1,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(appname: 'User Permission Managements'),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildPermissionSection("User Status", ["Active User"]),
                  const SizedBox(height: 10),
