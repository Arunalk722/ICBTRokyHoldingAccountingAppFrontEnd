                    ...
                    return Wrap(
                      ...
                      children: [
                        _buildReportCard(
                            ...
                            Icons.calculate,
                            Colors.orange,
                            ViewLocationWiseEstimationPage(
                              isEdit: false,
                            )),
                        _buildReportCard(
                            context,
                            ...
                            Icons.inventory,
                            Colors.redAccent,
                            ViewMaterialListPage(
                              isEdit: false,
                            )),
                        _buildReportCard(
                            context,
                            "View Project Wise Request List",
                            Icons.visibility,
                            Colors.pink,
                            ProjectPaymentRequestReportScreen()),
                        _buildReportCard(
                            context,
                            "Project Wise Item Request List",
                            Icons.list,
                            Colors.pink.shade100,
                            ProjectPaymentRequestItemsReportScreen()),
                        _buildReportCard(
                            context,
                            "View Office IOU",
                            ...
                            Colors.black54,
                            OfficeIOUList()),
                        _buildReportCard(context, "View IOU List",
                            Icons.visibility, Colors.pink, ViewIOUScreen()),
                        _buildReportCard(context, "Project Dashboard",
                            Icons.dashboard, Colors.pink, ProjectDashboard()),
                        _buildReportCard(
                            context,
                            "Item Consume",
                            Icons.request_page_outlined,
                            Colors.orangeAccent,
                            ProjectWiseEstimateItemConsume(
                              isEdit: false,
                            )),
                        _buildReportCard(
                            context,
