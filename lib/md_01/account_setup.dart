  ...
  Future<void> _loadUserInfo() async {
    ...
    try {
      ...
      final response = await http.post(
        ...
        body: jsonEncode({"username": UserCredentials().UserName}),
      );
        ...
        try {
          ...
          if (status == 200) {
            ...
            final String message =
                responseData['message'] ?? 'Error updating profile';
            PD.pd(text: message);
            OneBtnDialog.oneButtonDialog(
              context,
              title: 'Update Failed',
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildTextField(_txEmail, 'Email', 'Enter your email',
                      Icons.key, true, 45),
                  Row(
                    children: [
                      Expanded(
                  ...
                  buildPwdTextField(_txtCurrentPassword, 'Current Password',
                      'Enter your current', Icons.password_rounded, true, 20),
