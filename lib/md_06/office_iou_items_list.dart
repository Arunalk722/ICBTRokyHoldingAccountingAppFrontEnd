...
class OfficeIOUItemsList extends StatefulWidget {
  ...
  @override
  OfficeIOUItemsListState createState() => OfficeIOUItemsListState();
}

class OfficeIOUItemsListState extends State<OfficeIOUItemsList> {
  ...
  Future<void> fetchRequests() async {
    String apiURL =
        '${APIHost().apiURL}/report_controller.php/ViewOfficeIOUItemList';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData['status'] == 200) {
          ...
          setState(() {
            _requests = data
                .map((json) => PaymentRequestItemsDetail.fromJson(json))
                .toList();
  ...
  Future<void> exportPaymentRequestsToCSV(
      BuildContext context, List<PaymentRequestItemsDetail> requests) async {
    try {
