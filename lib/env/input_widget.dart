...
Widget buildNumberField(TextEditingController controller, String label,
    String hint, dynamic icon, bool vis, int maxLength) {
  return SizedBox(
    child: Visibility(
      visible: vis,
      child: TextFormField(
        ...
        decoration: InputDecoration(
          labelText: label,
          hintText: hint,
          prefixIcon: icon is IconData ? Icon(icon) : icon,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      child: DropdownButtonFormField<String>(
        ...
        value: widget.suggestions.contains(widget.controller.text)
...
Widget buildNumberWithReadOption(TextEditingController controller, String label,
    String hint, dynamic icon, bool isReadOnly, int maxLength) {
  return SizedBox(
    child: TextFormField(
      readOnly: isReadOnly,
      maxLength: maxLength,
