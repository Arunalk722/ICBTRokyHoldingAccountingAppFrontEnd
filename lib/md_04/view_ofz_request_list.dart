...
class ViewOfzRequestList extends StatefulWidget {
  ...
  @override
  State<ViewOfzRequestList> createState() => _ViewOfzRequestListState();
}
...
class _ViewOfzRequestListState extends State<ViewOfzRequestList> {
  ...
  Future<void> fetchRequestsById() async {
    ...
    try {
      ...
      ExceptionLogger.logToError(
          ...
          logFile: 'view_ofz_request_list.dart');
      WaitDialog.hideDialog(context);
      setState(() {
  ...
  Future<Uint8List> generatePdf(List<PaymentRequest> paymentRequests,
      List<RequestedItem> requestedItems) async {
        ...
        build: (pw.Context context) {
          return [
                  ...
                  pw.Row(
                    ...
                    children: [
                      pw.Text('Remarks: ${firstRequest.comment ?? ''}',
                          style: pw.TextStyle(fontSize: 8, font: ttf)),
                      pw.Text(
                          'Paid Account: ${firstRequest.ourAccountNumber ?? ''}',
                          style: pw.TextStyle(fontSize: 8, font: ttf)),
                    ],
                  ),
                ],
            ...
            pw.Row(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                buildApprovalBox('Authorized By', firstRequest.authUser,
                    firstRequest.authTime, firstRequest.authCmt, ttf, ttfBold),
                buildApprovalBox(
                    'Approved By',
                    ...
                    ttf,
                    ttfBold),
                buildApprovalBox('Paid By', firstRequest.pmtUser,
                    firstRequest.pmtTime, firstRequest.pmtCmt, ttf, ttfBold),
              ],
            ),
                        ...
                        pw.Padding(
                          ...
                          child: pw.Text(
                            NumberStyles.currencyStyle(
                                categoryTotals[mainCategory]![subCategory]!
                                    .toString()),
                            style: pw.TextStyle(fontSize: 7, font: ttf),
                ...
                pw.TableRow(
                  children: [
                    ...
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(3),
                      child: pw.Text(
                        NumberStyles.currencyStyle(((firstRequest.totalAmount +
                                    firstRequest.vat +
                                    firstRequest.sscl -
                                    firstRequest.addDis)
                                .toString())
        ...
        child: DataTable(
          ...
          rows: _requestedItems.map((item) {
            String formattedTotal =
                NumberFormat('#,###.00', 'en_US').format(item.totalAmount);
                          ...
                          onPressed: () {
                            if (item.newAmount! <= 0 ||
                              ...
                              YNDialogCon.ynDialogMessage(
                                context,
                                messageBody:
                                    'Confirm to Edit Item ${item.description} QTY :${item.newQuantity} and amount ${item.newAmount}',
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            YNDialogCon.ynDialogMessage(
                              context,
                              messageBody:
                                  'Confirm to remove Item ${item.description} QTY :${item.sumQuantity}',
                              ...
                              if (value == 1) {
                                removeRequestItem(context, item.requestListId,
                                    item.description, item.requestId);
                              }
                            });
                          },
                        ),
  ...
  Future<void> changePriceAndQty(
    ...
    try {
      ...
      String apiURL =
          '${APIHost().apiURL}/ofz_payment_controller.php/EditPriceAndQty';
      PD.pd(text: apiURL);
      final response = await http.post(
        Uri.parse(apiURL),
        headers: HttpHeader().header,
